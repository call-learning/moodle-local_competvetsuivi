...
use qbank_usage\tables\question_usage_table;
...
class autoevalutils {
    ...
    public static function get_student_results($userid, $matrix, $rootcomp = null) {
        ...
        /* @var $matrix \local_competvetsuivi\matrix\matrix The related matrix */
    ...
    public static function compute_results_recursively(&$currentresultarray, $matrix, $currentcomp) {
        ...
        $meanvalue = -1; // Value "Do not exist" not taken into account.
