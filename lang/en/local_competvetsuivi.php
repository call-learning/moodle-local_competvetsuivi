...
$string['contributionsamesemester:title'] = 'Percentage the {$a} contributes to competencies and knowledge for the <strong>semester to which it belongs</strong>';
...
$string['matrixaddedlog'] = 'Competencies loaded {$a->compcount}, Macrocompetencies {$a->macrocompcount}, UC/UE number {$a->uecount}.';
